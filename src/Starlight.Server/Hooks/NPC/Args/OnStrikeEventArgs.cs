...
namespace Starlight
{
    public sealed class OnStrikeEventArgs
    {
        ...
        public OnStrikeEventArgs(Player player, NPC nPC, int damage, float knockback, int hitDirection, bool critical, bool noEffect, bool fromNet)
        {
            Player = player;
            NPC = nPC;
            Damage = damage;
